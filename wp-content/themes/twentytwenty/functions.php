...
function wpb_custom_new_menu() {
	register_nav_menus(
    array(
		'fixed-bottom-menu' => __( 'Fixed Bottom Menu' ),
		'collapsible-menu' => __( 'Collapsible Menu' ),
		'home-absolute-menu' => __( 'Home Absolute Menu' ),
		'architecture-menu' => __( 'Architecture Menu' ),
		'interiors-menu' => __( 'Interiors Menu' ),
		'landscape-menu' => __( 'Landscape Menu' ),
		'press-menu' => __( 'Press Menu' ),
...
function modify_read_more_link() {
 return '<a class="more-link" href="' . get_permalink() . '">Xem thêm...</a>';
}
